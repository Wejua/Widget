...
struct DashBoardMediumThree: View {
                ...
                ZStack {
                    VStack(alignment: .leading, spacing: 0*factor) {
                        Text("\(date.hour):\(date.minute)")
                            .changeFont(model: model, originalFont: defaultFont, fontSize: 42*factor)
...
struct DashBoardMediumThree_Previews: PreviewProvider {
    static var previews: some View {
        ZStack {
            VStack {
                ...
                HStack {
                    Spacer()
                    DashBoardMediumThree(model: WidgetModel(id: .DashBoardMediumThree), date: Date())
//                        .frame(width: 329, height: 155)
                        .frame(width: 329/1.0, height: 155/1.0)
                    Spacer()
                }
                Spacer()
            }
